...
class LSDiscrete:
    def __init__(self, first_sensor, last_sensor, sensor_number, conveyor_type, line):
    ...
    def stat_on(self):
        ...
        for i in range(self.first_sensor, self.last_sensor + 1):
            dict1 = self.features()
            dict1[":IODisc"] = "LS{}{}{}{}_DB_Stat_On".format(self.sensor_number, self.conveyor_type_letter, i, self.line)
            dict1["ItemName"] = "LS{}{}{}{}_DB.Stat_On".format(self.sensor_number, self.conveyor_type_letter, i, self.line)
    ...
    def stat_off(self):
        ...
        for i in range(self.first_sensor, self.last_sensor + 1):
            dict1 = self.features()
            dict1[":IODisc"] = "LS{}{}{}{}_DB_Stat_Off".format(self.sensor_number, self.conveyor_type_letter, i, self.line)
            dict1["ItemName"] = "LS{}{}{}{}_DB.Stat_Off".format(self.sensor_number, self.conveyor_type_letter, i, self.line)
    ...
    def create_csv(self):
        csv_file = "csv-files/discrete/ls_discrete_{}_{}.csv".format(self.conveyor_type, self.line)
        dict_data = self.stat_off()
